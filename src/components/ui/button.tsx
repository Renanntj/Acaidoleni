  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium cursor-pointer transition-all duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:-translate-y-0.5 active:translate-y-0",
  {
    variants: {
      variant: {
        ...
        menu: "bg-highlight text-highlight-foreground border border-highlight shadow-sm hover:bg-highlight/90 hover:shadow-md",
        menuOutline:
          "border border-cream/35 bg-transparent text-cream hover:border-highlight hover:text-highlight hover:shadow-md",
      ...
      size: {
        ...
        icon: "h-9 w-9",
        menu: "h-12 rounded-sm px-6 text-sm font-extrabold uppercase tracking-[0.08em]",
      },
    },
    defaultVariants: {
      variant: "default",
